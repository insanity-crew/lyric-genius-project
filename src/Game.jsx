    ...
    <div>
      ...
      <div className="contentBox">
        ...
        <form onSubmit={compareAnswer}>
          <input type="text" name='guess' value={inputVal} onChange={(e)=>{setInputVal(e.target.value)}}/>
          <button type="submit">Guess</button>
        </form> <br/>
        <form >
          <input type="text" name="addsong" value={songInput}  onChange={(e)=> {setSongInput(e.target.value)}}/>
          <input type="text" name="addartist" value={artistInput} onChange={(e)=> {setArtistInput(e.target.value)}}/>
          <input type="text" name="addid" value={idInput} onChange={(e)=> {setIdInput(e.target.value)}}/>
